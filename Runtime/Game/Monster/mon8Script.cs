...
public class mon8Script : MonoBehaviour
{
    ...
    void StackAttack() 
    {
        ...
        if(transform.position.x < monster.transform.position.x && transform.position.y > monster.transform.position.y) // 왼쪽 상단
        {
        ...
        else if (transform.position.x > monster.transform.position.x && transform.position.y > monster.transform.position.y) // 오른쪽 상단
        {
        ...
        else if (transform.position.x > monster.transform.position.x && transform.position.y < monster.transform.position.y) // 오른쪽 하단
        {
        ...
        else if (transform.position.x < monster.transform.position.x && transform.position.y < monster.transform.position.y) // 왼쪽 하단
        {
