...
namespace Shop
{
    namespace Diamonds
    {
        public class Diamond_1000 : InAppPurchaseBase
        {
            ...
            {
                var validation = Backend.Receipt.IsValidateGooglePurchase(product.receipt, "다이아몬드 1,000개", false);
            ...
            {
                GameManager.Instance.userDataManager.ModifierCurrencyValue(CurrencyType.Diamond, 1_000);
