...
namespace Shop
{
    namespace Diamonds
    {
        public class Diamond_32000 : InAppPurchaseBase
        {
            ...
            {
                var validation = Backend.Receipt.IsValidateGooglePurchase(product.receipt, "다이아몬드 32,000개", false);
            ...
            {
                GameManager.Instance.userDataManager.ModifierCurrencyValue(CurrencyType.Diamond, 32_000);
