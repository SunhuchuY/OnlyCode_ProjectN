...
namespace Shop
{
    namespace Diamonds
    {
        public class Diamond_52000 : InAppPurchaseBase
        {
            ...
            {
                var validation = Backend.Receipt.IsValidateGooglePurchase(product.receipt, "다이아몬드 52,200개", false);
            ...
            {
                GameManager.Instance.userDataManager.ModifierCurrencyValue(CurrencyType.Diamond, 52_000);
