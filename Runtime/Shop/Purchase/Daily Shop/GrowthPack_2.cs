...
namespace Shop
{
    namespace Daily
    {
        public class GrowthPack_2 : DailyInAppPurchaseBase
        {
            public GrowthPack_2() : base("GrowthPack2") { } 
            ...
            {
                var validation = Backend.Receipt.IsValidateGooglePurchase(product.receipt, "성장팩_2", false);
            ...
            protected override void Purchase()
            {
                ...
                GameManager.Instance.userDataManager.ModifierCurrencyValue(CurrencyType.MagicStone, 5_500 * 1000);
